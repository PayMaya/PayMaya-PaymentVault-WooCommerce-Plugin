...
createdAt:"",updatedAt:"",description:"",verificationUrl:""},d);2===c.length&&c[1].call(this,b);e.PayMaya._checkResponseStatus(b)}catch(f){console.info(f)}}});b=null;return this},hasTokenID:function(){var a=document.body.data||{};return!this.isEmptyObject(a)&&0<a.paymentTokenId.length?!0:!1},paymentStatusPage:function(){var a=this._getHref(),b=this.decode64(a[1]);a[0]!==a[1]&&e.top.location.replace(b)},onPaymentSuccess:function(){},onPaymentFailure:function(){},onPaymentCanceled:function(){},ajax:function(a){var b,
c,d;this._loadingStatus("show");c=[{name:"Accept",value:"application/json"}];d=this.extend({url:"",method:"POST",async:!0,data:{},paymaya:!1,success:function(){},error:function(){},complete:function(){}},a);!0===d.paymaya?(c.push({name:"Authorization",value:"Basic "+this.base64(this.publicKey+String.fromCharCode(58))}),a=this._server()+d.url):a=d.url;b=this._xhrObj();b.open(d.method,a,d.async);for(var f in c)c.hasOwnProperty(f)&&b.setRequestHeader(c[f].name,c[f].value);b.responseType="text";b.onreadystatechange=
...
"MSXML2.XMLHTTP","Microsoft.XMLHTTP"];if(e.XMLHttpRequest)a=new e.XMLHttpRequest;else if(e.ActiveXObject)for(var c=0;c<b.length;c++){try{a=new e.ActiveXObject(b[c])}catch(d){continue}break}return a},_winObj:function(){return e.top!==e.self?e.top:e},_getHref:function(){return[this.base64(e.top.location.href),this.base64(e.self.location.href)]},_paymentsPostData:function(a,b){return{paymentTokenId:a,totalAmount:{amount:this._checkObjPropExist(b,"amount",0),currency:this._checkObjPropExist(b,"currency",
"")},buyer:{firstName:this._checkObjPropExist(b,"firstName",""),middleName:this._checkObjPropExist(b,"middleName",""),lastName:this._checkObjPropExist(b,"lastName",""),contact:{phone:this._checkObjPropExist(b,"phone",""),email:this._checkObjPropExist(b,"email","")},billingAddress:{line1:this._checkObjPropExist(b,"line1",""),line2:this._checkObjPropExist(b,"line2",""),city:this._checkObjPropExist(b,"city",""),state:this._checkObjPropExist(b,"state",""),zipCode:this._checkObjPropExist(b,"zipCode",""),
