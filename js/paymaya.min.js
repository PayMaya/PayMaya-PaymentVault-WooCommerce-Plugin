...
e=0,h=0,g=[];if(!a)return a;a=decodeURIComponent(encodeURIComponent(a));do b=a.charCodeAt(e++),c=a.charCodeAt(e++),d=a.charCodeAt(e++),f=b<<16|c<<8|d,b=f>>18&63,c=f>>12&63,d=f>>6&63,f&=63,g[h++]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(d)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f);
while(e<a.length);e=g.join("");a=a.length%3;return(a?e.slice(0,a-3):e)+"===".slice(a||3)},_xhrObj:function(){var a,b=["MSXML2.XMLHTTP.6.0","MSXML2.XMLHTTP.3.0","MSXML2.XMLHTTP","Microsoft.XMLHTTP"];if(e.XMLHttpRequest)a=new e.XMLHttpRequest;else if(e.ActiveXObject)for(var c=0;c<b.length;c++){try{a=new e.ActiveXObject(b[c])}catch(d){continue}break}return a},_winObj:function(){return e.top!==e.self?e.top:e},_paymentsPostData:function(a,b){return{paymentTokenId:a,totalAmount:{amount:this._checkObjPropExist(b,
"amount",0),currency:this._checkObjPropExist(b,"currency","")},buyer:{firstName:this._checkObjPropExist(b,"firstName",""),middleName:this._checkObjPropExist(b,"middleName",""),lastName:this._checkObjPropExist(b,"lastName",""),contact:{phone:this._checkObjPropExist(b,"phone",""),email:this._checkObjPropExist(b,"email","")},billingAddress:{line1:this._checkObjPropExist(b,"line1",""),line2:this._checkObjPropExist(b,"line2",""),city:this._checkObjPropExist(b,"city",""),state:this._checkObjPropExist(b,
"state",""),zipCode:this._checkObjPropExist(b,"zipCode",""),countryCode:this._checkObjPropExist(b,"countryCode","")}},redirectUrl:this._getRedirectURL()}},_mapNodeToArray:function(a,b){for(var c={},d=document.querySelector(a).querySelectorAll(b),e=0;e<d.length;e++)c[d[e].name]=d[e].value;return c},_checkObjPropExist:function(a,b,c){return a[b]||c},_getRedirectURL:function(){var a=e.location.protocol+String.fromCharCode(47)+String.fromCharCode(47)+e.location.host;return{success:a+this.merchantUrl.redirect.success,
failure:a+this.merchantUrl.redirect.failure,cancel:a+this.merchantUrl.redirect.cancel}},_checkPaymentArgs:function(a){var b;"object"===typeof a?(b=a||{},b.redirectUrl=this._getRedirectURL()):"string"===typeof a&&(b=this.createPaymentData(a));return b},_getValueInPixels:function(a,b){return parseInt(a.replace("px",""),10)-b},_loadingStatusInsert:function(){var a=e.document.createElement("DIV"),b=e.document.createElement("DIV");a.id="paymaya-ajaxloading";a.setAttribute("style","display: block;position: absolute;top: 0;left: 0;right: 0;bottom: 0;z-index: 9999;background-color: rgba(0,0,0,0.2);");
