...
include( __DIR__ . '/WC_CustomOrderDataPV.php' );
 ...
 * @global $wpdb;
 */
function woocommerce_customorder_data_activate() {
    global $wpdb;

    // create custom order data table
    $wpdb->query('
      CREATE TABLE IF NOT EXISTS wp_woocommerce_customorder_data (
 ...
 */
function woocommerce_customorder_data_loadFirst() {
    // init path
...
add_action('activated_plugin', 'woocommerce_customorder_data_loadFirst');